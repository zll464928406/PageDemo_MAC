...
@implementation MXPageControlCell
...
-(void)updateCurrentPageDisplay
{
    ...
    _matrix = [[NSMatrix alloc] initWithFrame: frame mode: NSRadioModeMatrix cellClass: [MXPageControlCell class] numberOfRows: 1 numberOfColumns: _numberOfPages];
    ...
    [_matrix.cells enumerateObjectsUsingBlock: ^(id obj, NSUInteger idx, BOOL *stop){
        MXPageControlCell *cell = (MXPageControlCell *)obj;
